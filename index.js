...
while(x) {
  ...
  console.log('\n');
  console.log(`Enter a number between 1 - ${x+1} | To exist Enter the number 0`);
  ...
  if (guess == 0){
    ...
    x++;
    console.log(`Correct Guess!!. You have Earned: ${points = 1} Point.\nYour total point is ${x-1}.\nYou are now in Stage: `,  x-1);
  }else{
